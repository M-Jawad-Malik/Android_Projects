...
public class PlaceDeatil extends AppCompatActivity implements LocationPickerDialog.OnLocationSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        netsgnl = findViewById(R.id.netsgnl);
        ...
        saveplc_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.set(new Place(new ArrayList<ActivityClass>(),Integer.parseInt(airquality.getText().toString().subSequence(13,14).toString()), catur.getText().toString(), caten.getText().toString(), new Cost( Integer.parseInt(entrncfee.getText().toString()), Integer.parseInt(food.getText().toString()), Integer.parseInt(transpot.getText().toString()), new ArrayList<Integer>()), desur.getText().toString(), desen.getText().toString(), 0, getImgUrl(selectedImage).toString(), 0, latitude, longitude, nmur.getText().toString(), nmen.getText().toString(), recage.getText().toString(), Integer.parseInt(recsesn.getText().toString()), Integer.parseInt(rectime.getText().toString()), "", reckey.getText().toString())).addOnCompleteListener(new OnCompleteListener<Void>() {
