...
// finally change the color
    ...
    public void showDetailedCost(final int position) {
        ...
        entrenceFeesPrice.setText(mPlace.get(position).cost.entranceFees + " RS");

        TextView foodPrice = mView.findViewById(R.id.food_price);
        foodPrice.setText(mPlace.get(position).cost.food + " RS");


        final TextView transportationPrice = mView.findViewById(R.id.transportation_price);
        transportationPrice.setText(mPlace.get(position).cost.transportation + " RS");
        ...
        applyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setEstimatedTime(transportationCheckbox.isChecked() ?  act_time : act_time);
                alertDialog.dismiss();
    ...
    public void place_btn(View view) {
        ...
        Toast.makeText(this,String.valueOf("Detailed Activity: "+lat+" "+lng),Toast.LENGTH_LONG).show();
    ...
    public void pageSelectedPlace(int position) {
        ...
        int deff = mPlace.get(position).cost.entranceFees + mPlace.get(position).cost.food + mPlace.get(position).cost.transportation ;
        ...
        setEstimatedTime( prefs.getintPrefs("act_time", 0));
    ...
    private void setCostProgress(int cost) {
        ...
        costTv.setText(getResources().getString(R.string.JD)+" "+cost  );
...
//                break;
   ...
   //     text_to_speech = findViewById(R.id.text_to_speech);
    ...
    public void setFirstPlaceDetails() {
        ...
        int deff = mPlace.get(0).cost.entranceFees + mPlace.get(0).cost.food + mPlace.get(0).cost.transportation ;
