...
public class InterestsAdapter extends RecyclerView.Adapter<InterestsAdapter.ImageViewHolder> {
    ...
    public InterestsAdapter(Context context) {
        ...
        interests_ur = context.getResources().getStringArray(R.array.interestsUR);
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        } else  if (SplashScreenActivity.lan.equalsIgnoreCase("ur")) {
            holder.category.setText(interests_ur[position].trim());
        }
        else {
